...
/************************* WRITE HANDLE *************************/
/**
 * handle_write_char - string is printed
 * @c: type of character
 * @buffer: Buffer array to be printed
 * @flags:  active-flags to be calculated
 * @width: get width
 * @precision: precision specifier to print
 * @size: Size-specifier
 *
 * Return: print Number-chars
 */
 ...
 * @size: Size-specifier
 *
 * Return: character-number is printed.
 */
...
/**
 * write_num - number with bufffer
 * @ind: Index where number in buffer
 * @buffer: Buffer
 * @flags: Flags
 * @width: width
 ...
 * @extra_c: Extra-char
 *
 * Return: Number of characters is printed
 */
...
/**
 * write_unsgnd - print unsigned-number
 * @is_negative: Number shows if num is negative
 * @ind: Index where number in the buffer
 * @buffer: Array of characters
 * @flags: Flags-specifiers
 * @width: Width-specifier
 * @precision: Precision-specifier
 * @size: Size specifier of size
 *
 * Return: Number-characters is written
 */
...
/**
 * write_pointer - print address of memory
 * @buffer: characters of array
 * @ind: Index wher number in the buffer
 * @length: number-length
 * @width: Width-specifier
 * @flags: Flags-specifier
 * @padd: Character represent padding
 * @extra_c: Character of extra char is presented
 * @padd_start: Index where padding should be started
 *
 * Return: Number of characters is written
 */
